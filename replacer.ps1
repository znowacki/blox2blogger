...
$content = $content.Replace("<wp:wxr_version>1.2</wp:wxr_version>","<generator version='7.00' uri='https://www.blogger.com'>Blogger</generator><title type='text'>Title</title><id>https://blox.pl/</id><link rel='self' type='application/atom+xml' href='https://blox.pl'/>")
$content = $content.Replace("</channel>","</feed>")
